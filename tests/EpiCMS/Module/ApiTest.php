...
class EpiCMS_Module_ApiTest extends PHPUnit_Framework_TestCase {
    ...
    public function testGetRouteStatus() {
        $this->checkStatusCode('GET', '/admin/text/namespace/test-1', 200);
    }

    public function testPostRouteStatus() {
        $this->checkStatusCode('POST', '/admin/text/namespace/test-1', 200);
    }

    public function testGetRouteContent() {
        $this->checkOutput('GET', '/admin/text/namespace/test-1', '{"key":"namespace:test-1:text","value":"test1"}');
    }

    public function testPostRouteContent() {
        $this->checkOutput('POST', '/admin/text/namespace/test-1', '{"status":"ok","value":"test1"}');
    }
