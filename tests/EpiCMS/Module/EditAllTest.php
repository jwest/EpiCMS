...
class EpiCMS_Module_EditAllTest extends EpiCMS_Module_ModuleTesting {
    ...
    public function testGetRouteOutputJSONData() {
        $this->checkOutput('GET', '/admin/editAll', '{"boxes":{"namespace:test-1":{"_type":"undefined","value":"test"},"namespace2:test-1":{"_type":"undefined","value":"test3"},"namespace2:test-2":{"_type":"undefined","value":"test4"},"namespace2:test-3":{"_type":"undefined","value":"test5"},"page:main":{"_type":"undefined","value":"main-page"},"page:test-page":{"_type":"undefined","value":"test-page"}}}', '', array('X_REQUESTED_WITH' => 'XMLHttpRequest'));
    }
